...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group row">
        <label class="control-label col-xs-12 col-sm-2" for="TXTCode">Code:</label>
        <div class="col-xs-12 col-sm-5">
    ...
    <div class="form-group row">
        <label class="control-label col-xs-12 col-sm-2" for="TXTName">Name:</label>
        <div class="col-xs-12 col-sm-5">
    ...
    <div class="form-group row">
        <label class="control-label col-xs-12 col-sm-2" for="TXTPhone">Phone:</label>
        <div class="col-xs-12 col-sm-5">
    ...
    <div class="form-group row">
        <label class="control-label col-xs-12 col-sm-2" for="TXTOtherPhone">Other Phone:</label>
        <div class="col-xs-12 col-sm-5">
    ...
    <div class="form-group row">
        <label class="control-label col-xs-12 col-sm-2" for="TXTFax">Fax:</label>
        <div class="col-xs-12 col-sm-5">
    ...
    <div class="form-group row">
        <label class="control-label col-xs-12 col-sm-2" for="TXTFirstName">Contact First Name:</label>
        <div class="col-xs-12 col-sm-5">
    ...
    <div class="form-group row">
        <label class="control-label col-xs-12 col-sm-2" for="TXTLastName">Contact Last Name:</label>
        <div class="col-xs-12 col-sm-5">
    ...
    <div class="form-group row">
        <label class="control-label col-xs-12 col-sm-2" for="TXTGSTNumber">GST Number:</label>
        <div class="col-xs-12 col-sm-5">
